...
interface Contributors: CoroutineScope {
    ...
    fun loadContributors() {
        ...
        when (getSelectedVariant()) {
            ...
            /*By calling SwingUtilities.invokeLater we ensure that the updateResults call which updates the results happens on the main UI thread (AWT event dispatching thread*/
